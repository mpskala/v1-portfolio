...
export default function Container(props) {
	...
	return (
		<div className='bg-gray-50 dark:bg-gray-900'>
			...
			<div className='sticky flex flex-col justify-center px-8'>
				<nav className='flex items-center justify-between w-full relative max-w-2xl border-gray-200 dark:border-gray-700 mx-auto py-8 sm:pb-16  text-gray-900 bg-gray-50  dark:bg-gray-900 dark:bg-opacity-75 bg-opacity-75 dark:text-gray-100'>
